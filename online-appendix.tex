...
\titleformat{\subsection}[hang]{\bfseries\raggedright}{\thesubsection}{1em}{}
\titleformat{\subsubsection}[hang]{\bfseries\itshape\raggedright}{\thesubsubsection}{1em}{}

\begin{document}

\begin{center}
{\Large\bfseries Online Appendix}\\[1em]
{\large AI Agents and Sarbanes-Oxley Internal Control:\\
Six Structural Gaps in Financial Reporting}\\[1.5em]
